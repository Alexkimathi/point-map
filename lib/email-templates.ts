...
<title>Pointmap Solution Notification</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
          ...
          <tr>
            <td style="background:#1d4ed8;padding:24px 32px;border-radius:8px 8px 0 0;">
              <span style="color:#ffffff;font-size:22px;font-weight:700;letter-spacing:0.5px;">Pointmap Solution</span>
            </td>
          </tr>
          <!-- Body -->
          <tr>
          ...
          <tr>
            <td style="background:#f9fafb;padding:16px 32px;border:1px solid #e5e7eb;border-top:none;border-radius:0 0 8px 8px;text-align:center;">
              <p style="margin:0;color:#9ca3af;font-size:12px;">This is an automated notification from Pointmap Solution. Please do not reply to this email.</p>
            </td>
          </tr>
        </table>
      </td>
...
export function jobDeliveredEmailTemplate(data: JobDeliveredData): { subject: string; html: string } {
  ...
  const content = `
    ...
    <p style="margin:0;color:#6b7280;font-size:13px;">Log in to Pointmap Solution to view the full job details and related documents.</p>
  `
...
export function invoiceSentEmailTemplate(data: InvoiceSentData): { subject: string; html: string } {
  ...
  const content = `
    ...
    <p style="margin:0;color:#6b7280;font-size:13px;">Log in to Pointmap Solution to view the full invoice details and make a payment record.</p>
  `
