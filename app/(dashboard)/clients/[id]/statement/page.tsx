    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto p-10">
        ...
        <div className="flex justify-between items-start mb-8">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Pointmap Solution</h1>
        ...
        <div className="mt-6 p-4 bg-blue-50 rounded-lg">
          ...
          <p className="text-sm text-gray-700">Account Name: Pointmap Solution</p>
          <p className="text-sm text-gray-700">Account No: XXXX XXXX XXXX</p>
        </div>

        <p className="text-center text-xs text-gray-400 mt-10">
          This statement was generated on {printDate} — Pointmap Solution
        </p>
      </div>
